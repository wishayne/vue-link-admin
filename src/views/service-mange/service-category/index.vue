    ...
    <div>
        ...
        <div v-if="whenAdd">
            <el-form ref="addForm" :model="addForm" :rules="rules" label-width="80px">
                <el-form-item label="类别名称">
                    <el-input v-model="addForm.catelogyName"></el-input>
                </el-form-item>
                <el-form-item label="详细描述">
                    <el-input type="textarea" autosize placeholder="请输入详细描述" v-model="addForm.description"></el-input>
                </el-form-item>
                <el-form-item>
        ...
        <div v-if="whenUpdate">
            <el-form ref="updateForm" :model="updateForm" :rules="rules" label-width="80px">
                <el-form-item label="类别名称">
                    <el-input v-model="updateForm.catelogyName"></el-input>
                </el-form-item>
                <el-form-item label="详细描述">
                    <el-input type="textarea" autosize placeholder="请输入详细描述" v-model="updateForm.description"></el-input>
                </el-form-item>
                <el-form-item>
