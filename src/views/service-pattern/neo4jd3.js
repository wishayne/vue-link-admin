...
(function(f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f() } else if (typeof define === 'function' && define.amd) { define([], f) } else { var g; if (typeof window !== 'undefined') { g = window } else if (typeof global !== 'undefined') { g = global } else if (typeof self !== 'undefined') { g = self } else { g = this }g.Neo4jd3 = f() } })(function() {
  var define, module, exports; return (function() { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = typeof require === 'function' && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = 'MODULE_NOT_FOUND', a } var p = n[i] = { exports: {}}; e[i][0].call(p.exports, function(r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = typeof require === 'function' && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({ 1: [function(_dereq_, module, exports) {
    ...
    function Neo4jD3(_selector, _options) {
      var container; var graph; var info; var legend; var node; var nodes; var relationship; var relationshipOutline; var relationshipOverlay; var relationshipText; var relationships; var selector; var simulation; var svg; var svgNodes; var svgRelationships; var svgScale; var svgTranslate
      var classes2colors = {}
      ...
      function appendLegendPanel(container) {
        return container.append('div').attr('class', 'neo4jd3-legend')
      }
        ...
        return node.append('circle')
          ...
          .attr('r', function(d) {
            switch (d.properties.$type) {
              case 'Fault':
                return options.nodeRadius * 1.5
              case 'FeatureGroup':
              case 'ReasonGroup':
              case 'ComponentGroup':
                return options.nodeRadius * 0.75
              case 'Reason':
              case 'Component':
              case 'Feature':
          ...
          .style('fill', function(d) {
            return typeToColor(d) || (options.nodeOutlineFillColor ? options.nodeOutlineFillColor : class2color(d.labels[0]))
          })
          .style('stroke', function(d) {
            var color = (options.nodeOutlineFillColor ? options.nodeOutlineFillColor : class2color(d.labels[0]))
            return typeToDarkColor(d) || d3.rgb(color).darker(1)
      ...
      //                 .attr('y', function(d) {
      //                     return icon(d) ? (parseInt(Math.round(options.nodeRadius * 0.82)) + 'px') : '9px';
      //                 })
      //                 .html(function(d) {
      // //                       var _icon = icon(d);
      // //                       return _icon ? '&#x' + _icon : findFirstValue(d);
      //                     return d["properties"].quantum?d["properties"].quantum:'';
      //                 });
        ...
        return node.append('text')
          ...
          // return typeToTextColor(d) || colorReverse(typeToColor(d) || "#fff000");
            return d3.rgb(colorReverse(typeToColor(d) || '#fff000')).darker(1)
          })
          .attr('font-size', function(d) {
            return icon(d) ? (options.nodeRadius + 'px') : '10px'
          })
          ...
          .attr('text-anchor', 'middle')
          .attr('y', function(d) {
          // if (d["properties"].quantum){
          //     return icon(d) ? (parseInt(Math.round(options.nodeRadius * -0.22)) + 'px') : '-1px';
          // }
          ...
          //                       var _icon = icon(d);
          //                       return _icon ? '&#x' + _icon : findFirstValue(d);
            return findFirstValue(d)
          })
      }

      function typeToColor(d) {
        switch (d.properties.$type) {
          case 'Fault':
            return '#F16667'
          case 'Reason':
      ...
      function findFirstValue(d) {
        ...
        switch (d.properties.$type) {
          ...
          case 'ReasonGroup':
          case 'ComponentGroup':
            return d.properties.combineType
          case 'Feature':
            return d.properties.name + d.properties.opertion + d.properties.params
        }
        return d.id || ''
      }
      ...
      function appendTextToRelationship(r) {
        return r.append('text')
          ...
          .attr('text-anchor', 'middle')
          .text(function(d) {
          // return d.type + (d['properties']["概率"]?'('+d['properties']["概率"]+')':'') ;
            return d['properties']['概率'] ? d['properties']['概率'] : ''
          })
      }
      ...
      function init(_selector, _options) {
        ...
        if (options.legendPanel) {
          legend = appendLegendPanel(container)
        }
...
*/
      ...
      // Array.prototype.push.apply(nodes, n);
        Array.prototype.push.apply(nodes, n.filter(function(node) {
          return !nodes.some(function(value) { return node.id == value.id })
        }))
      ...
      // Array.prototype.push.apply(relationships, r);
        Array.prototype.push.apply(relationships,
          r.filter(function(rel) {
            return !relationships.some(function(value) { return rel.startNode == value.startNode && rel.endNode == value.endNode })
          }))
      ...
      function zoomFit(transitionDuration) {
        ...
        var bounds = svg_node.getBBox()
        var parent = svg_node.parentElement.parentElement
